      ...
      <div className="w-full xl:py-2">
        <div className="flex flex-col items-center justify-center">
          ...
          <button
            ...
            disabled={loading}
            className={`mt-7 flex items-center justify-center gap-2 rounded-lg border border-[#47CD63] bg-[#47CD63] px-4 py-4 font-normal uppercase text-[#FFFFFF] max-sm:w-full md:w-[682px] ${
              loading ? "opacity-50" : ""
            }`}
          >
